...
public interface DBIndexStore {
     ...
     * added, should not be added, or if should not be added the the entire
     * protein should be skipped
     */
     ...
     * @param sequenceOffset sequence offset into the original protein sequence
     ...
     * @throws DBIndexStoreException exception thrown when an error associated
     * with the underlying DB storage occurred
     */
     ...
     * tolerance is mass dependant and it is already scaled / pre-calculated
     * tolerance for that mass to use example: resulting mass range will be
     ...
     * @throws DBIndexStoreException exception thrown when an error associated
     * with the underlying DB storage occurred and protein could not be added to
     * the index
     */
     ...
     *
     * @param proteinCache in memory protein database, map of definition
     * accession to sequence
     */
     ...
     * @throws DBIndexStoreException exception thrown when an error associated
     * with the underlying DB storage occurred and could not retrieve the
     * protein definition, or if no protein found in the index by that id
     */
